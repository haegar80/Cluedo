...
void AskPlayerUI::setupUi()
{
    ...
    m_labelPlayer->setGeometry(QRect(20 * fW, 380 * fH, 161 * fW, 16 * fH));
    m_labelPlayerName = new QLabel(m_centralwidget);
    m_labelPlayerName->setObjectName(QStringLiteral("labelPlayerName"));
    m_labelPlayerName->setGeometry(QRect(20 * fW, 410 * fH, 201 * fW, 16 * fH));
    ...
    m_labelPlayerNoObjects->setGeometry(QRect(20 * fW, 470 * fH, 201 * fW, 16 * fH));
    ...
    m_labelPlayerNameNoObjects1->setGeometry(QRect(20 * fW, 500 * fH, 201 * fW, 16 * fH));
    ...
    m_labelPlayerNameNoObjects2->setGeometry(QRect(20 * fW, 520 * fH, 201 * fW, 16 * fH));
    ...
    m_labelPlayerNameNoObjects3->setGeometry(QRect(20 * fW, 540 * fH, 201 * fW, 16 * fH));
    ...
    m_labelPlayerNameNoObjects4->setGeometry(QRect(20 * fW, 560 * fH, 201 * fW, 16 * fH));
    ...
    m_labelPlayerNameNoObjects5->setGeometry(QRect(20 * fW, 580 * fH, 201 * fW, 16 * fH));
    ...
    m_labelPlayerNameNoObjects6->setGeometry(QRect(20 * fW, 600 * fH, 201 * fW, 16 * fH));
    ...
    m_labelShowedObject->setGeometry(QRect(260 * fW, 380 * fH, 171 * fW, 16 * fH));
    ...
    m_imageShowedObject->setGeometry(QRect(260 * fW, 410 * fH, 211 * fW, 281 * fH));
    ...
    m_buttonOk->setGeometry(QRect(20 * fW, 670 * fH, 75 * fW, 23 * fH));
