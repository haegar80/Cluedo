...
void SelectObjectToShowUI::setupUi()
{
    ...
    m_labelAskedPerson->setGeometry(QRect(90 * fW, 20 * fH, 401 * fW, 16 * fH));
    ...
    m_labelAvailableObjects->setGeometry(QRect(10 * fW, 400 * fH, 251 * fW, 16 * fH));
    ...
    m_labelAvailableMurder->setGeometry(QRect(10 * fW, 430 * fH, 51 * fW, 16 * fH));
    ...
    m_labelAvailableWeapon->setGeometry(QRect(270 * fW, 430 * fH, 51 * fW, 16 * fH));
    m_labelAvailableRoom = new QLabel(m_centralwidget);
    m_labelAvailableRoom->setObjectName(QStringLiteral("labelAvailableRoom"));
    m_labelAvailableRoom->setGeometry(QRect(520 * fW, 430 * fH, 111 * fW, 16 * fH));
