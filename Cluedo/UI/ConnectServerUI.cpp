...
void ConnectServerUI::setupUi()
{
    ...
    m_labelIPAddressServer->setGeometry(QRect(30 * fW, 20 * fH, 101 * fW, 16 * fH));
    ...
    m_buttonCancel->setGeometry(QRect(160 * fW, 110 * fH, 81 * fW, 21 * fH));
