...
void StartGameUI::setupUi()
{
    ...
    m_lineEditPlayerName->setGeometry(QRect(20 * fW, 70 * fH, 131 * fW, 20 * fH));
    m_labelPlayerName = new QLabel(m_centralwidget);
    m_labelPlayerName->setObjectName(QString::fromUtf8("labelPlayerName"));
    m_labelPlayerName->setGeometry(QRect(20 * fW, 40 * fH, 131 * fW, 16 * fH));
    ...
    m_labelNumberOfComputerPlayers->setGeometry(QRect(220 * fW, 40 * fH, 211 * fW, 16 * fH));
    ...
    m_comboBoxNumberOfComputerPlayers->setGeometry(QRect(220 * fW, 70 * fH, 69 * fW, 22 * fH));
    ...
    m_labelNumberOfRemotePlayers->setGeometry(QRect(220 * fW, 120 * fH, 231 * fW, 16 * fH));
    ...
    m_comboBoxNumberOfRemotePlayers->setGeometry(QRect(220 * fW, 150 * fH, 69 * fW, 22 * fH));
    m_buttonStartGame = new QPushButton(m_centralwidget);
    m_buttonStartGame->setObjectName(QString::fromUtf8("buttonStartGame"));
    m_buttonStartGame->setGeometry(QRect(20 * fW, 200 * fH, 101 * fW, 23 * fH));
