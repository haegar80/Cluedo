...
void CluedoUI::setupUi()
{
    ...
    m_selectionObjectWidget->setGeometry(QRect(60 * fW, 50 * fH, 891 * fW, 681 * fH));
    ...
    m_labelCluedoObjects->setGeometry(QRect(40 * fW, 30 * fH, 141 * fW, 16 * fH));
    ...
    m_labelCluedoObject1->setGeometry(QRect(40 * fW, 60 * fH, 111 * fW, 16 * fH));
    ...
    m_labelCluedoObject2->setGeometry(QRect(180 * fW, 60 * fH, 111 * fW, 16 * fH));
    ...
    m_labelCluedoObject3->setGeometry(QRect(320 * fW, 60 * fH, 111 * fW, 13 * fH));
    ...
    m_labelCluedoObject4->setGeometry(QRect(460 * fW, 60 * fH, 111 * fW, 13 * fH));
    ...
    m_labelCluedoObject5->setGeometry(QRect(600 * fW, 60 * fH, 111 * fW, 13 * fH));
    ...
    m_labelCluedoObject6->setGeometry(QRect(740 * fW, 60 * fH, 111 * fW, 13 * fH));
    ...
    m_imageCluedoObject1->setGeometry(QRect(40 * fW, 90 * fH, 120 * fW, 160 * fH));
    ...
    m_imageCluedoObject2->setGeometry(QRect(180 * fW, 90 * fH, 120 * fW, 160 * fH));
    ...
    m_imageCluedoObject3->setGeometry(QRect(320 * fW, 90 * fH, 120 * fW, 160 * fH));
    ...
    m_imageCluedoObject4->setGeometry(QRect(460 * fW, 90 * fH, 120 * fW, 160 * fH));
    ...
    m_imageCluedoObject5->setGeometry(QRect(600 * fW, 90 * fH, 120 * fW, 160 * fH));
    ...
    m_imageCluedoObject6->setGeometry(QRect(740 * fW, 90 * fH, 120 * fW, 160 * fH));
    ...
    m_labelCurrentPlayer->setGeometry(QRect(970 * fW, 50 * fH, 111 * fW, 16 * fH));
    ...
    m_listPlayers->setGeometry(QRect(970 * fW, 80 * fH, 256 * fW, 131 * fH));
    ...
    m_buttonSelectObjects->setGeometry(QRect(970 * fW, 230 * fH, 261 * fW, 41 * fH));
    m_buttonStartGame = new QPushButton(m_centralwidget);
    m_buttonStartGame->setObjectName(QString::fromUtf8("buttonStartGame"));
    m_buttonStartGame->setGeometry(QRect(60 * fW, screenGeometry.height() - 73 * fH, 111 * fW, 23 * fH));
    m_buttonConnectGame = new QPushButton(m_centralwidget);
    m_buttonConnectGame->setObjectName(QStringLiteral("buttonConnectGame"));
    m_buttonConnectGame->setGeometry(QRect(190 * fW, screenGeometry.height() - 73 * fH, 171 * fW, 23 * fH));
